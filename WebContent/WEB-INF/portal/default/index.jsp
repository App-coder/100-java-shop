...
<script type='text/javascript' src="resource/portal/default/js/jquery-1.6.2.min.js"></script>
<link rel="stylesheet" type="text/css" href="resource/portal/default/css/index.css" />
<link rel="stylesheet" type="text/css" href="resource/portal/default/css/jquery.jqzoom.css" />
<link rel="stylesheet" type="text/css" href="resource/portal/default/jquery.bxSlider/bx_styles/bx_styles.css" />
</head>
<body class="index">
	<div class="container">
		<div class="header">
		...
		<div class="navbar">
			<ul>
                ...
                <c:forEach items="${front_guide}" var="guide" varStatus="s">
                    <c:choose>
                        <c:when test="${s.index+1 == fn:length(front_guide)}">
                            <li style="background: none;"><a href="${guide.link}">${guide.name}<span> </span></a></li>
                        </c:when>
                        <c:otherwise>
                            <li><a href="${guide.link}">${guide.name}<span> </span></a></li>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
			</ul>
