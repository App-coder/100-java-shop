...
String win_topbar = "closed=\"true\" modal=\"true\" collapsible=\"false\"  draggable=\"false\" minimizable=\"false\" maximizable=\"false\" inline=\"false\" resizable=\"false\"";
      ...
      out.write("    ");
      out.write("\t\r\n");
      out.write("<script type=\"text/javascript\" src=\"resource/admin/js/admin.js\"></script>\r\n");
      out.write("<div class=\"hidden\">\r\n");
      out.write("\t<div id=\"admin_add\" class=\"easyui-window\" ");
      out.print(win_topbar );
      out.write(" title=\"添加管理员\">  \r\n");
      out.write("\t\t\t\t\t<div region=\"center\"  border=\"false\" class=\"bdcenter\">\r\n");
      out.write("\t\t\t\t\t\t\t<form method=\"post\" id=\"form_admin_edit\" >\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\tname=\"adminName\"  required=\"true\" validType=\"length[1,50]\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"edittd\">密码：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><input type=\"text\" class=\"text easyui-validatebox\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tname=\"password\" required=\"true\" validType=\"length[1,100]\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"edittd\">重复密码：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><input type=\"text\" class=\"text easyui-validatebox\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tname=\"re_password\" required=\"true\" validType=\"length[1,100]\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td class=\"edittd\">角色：</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><select name=\"roleId\" id=\"admin_roleId\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<td><input type=\"text\" class=\"text easyui-validatebox\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tname=\"email\" required=\"true\" validType=\"length[1,100]\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\thref=\"javascript:void(0)\" onclick=\"formsubmit('form_admin_edit')\">编辑</a> <a\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"easyui-linkbutton\" iconCls=\"icon-cancel\"\r\n");
      out.write("\t\t\t\t\t\t\t\thref=\"javascript:void(0)\" onclick=\"closeWin('admin_add')\">取消</a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write(" \t\t\t\t</div>  \r\n");
      out.write("</div>\r\n");
      out.write("<table id=\"adminlist\" title=\"管理员列表\" fit=\"true\"></table>");
    } catch (Throwable t) {
