...
String win_topbar = "closed=\"true\" modal=\"true\" collapsible=\"false\"  draggable=\"false\" minimizable=\"false\" maximizable=\"false\" inline=\"false\" resizable=\"false\"";
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("<script type=\"text/javascript\" src=\"resource/admin/js/model.js\"></script>\r\n");
      out.write("<div class=\"container\">\r\n");
      out.write("<div class=\"hidden\" >\r\n");
      out.write("\t<div id=\"model_add\" class=\"easyui-window\" ");
      out.print(win_topbar );
      out.write(" style=\"width:500px;\" title=\"添加模型\" >  \r\n");
      out.write("\t\t<div region=\"center\"  border=\"false\" >\r\n");
      out.write("\t\t<form id=\"form_model_add\" method=\"post\" >\r\n");
      out.write("\t\t\t<div class=\"easyui-tabs\"  border=\"false\" style=\"height:300px;\"  >\r\n");
      out.write("\t\t\t\t<div title=\"基本信息\" class=\"p10\" >\r\n");
      out.write("\t\t\t\t\t<table class=\"tab_form\">\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"edittd\">模型名称：</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input type=\"text\" class=\"text easyui-validatebox\" name=\"name\" required=\"true\" validType=\"length[1,50]\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write(" \t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div title=\"规格\" class=\"p10\" >\r\n");
      out.write("\t\t\t\t\t<table class=\"tab_form\">\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td colspan=\"2\">规格列表</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\thref=\"javascript:void(0)\" onclick=\"formsubmit('form_model_add')\">保存</a> <a\r\n");
      out.write("\t\t\t\t\tclass=\"easyui-linkbutton\" iconCls=\"icon-cancel\"\r\n");
      out.write("\t\t\t\t\thref=\"javascript:void(0)\" onclick=\"closeWin('model_add')\">取消</a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("    </div>\r\n");
      out.write("</div>\r\n");
      out.write("<table id=\"model_list\"></table>\r\n");
      out.write("</div>");
    } catch (Throwable t) {
