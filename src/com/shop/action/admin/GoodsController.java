...
public class GoodsController extends BaseController {
	 ...
	 * @param isdel 上下架
	 * @param storenums 库存数量
	 * @param commend 商品标签
	 * @return
	 */
	@RequestMapping(value = "/filter", method = RequestMethod.POST)
	@ResponseBody
	public String filter(int page,int rows,int categoryid,int isdel,int storenums,int commend){
		
		int total = this.goodsService.getTotalFilterGoods(categoryid,isdel,storenums,commend);
		List<ShopGoods> goods = this.goodsService.loadGoodsFilterGoods(categoryid,isdel,storenums,commend);
